...
function App() {
const [verificationId, setverificationId] = useState("Login");
const handleClick = () => {
  setverificationId("@2345qewretrewq");
  navigator.clipboard.writeText(verificationId);
  setTimeout(() => {
    setverificationId("Login");
  }, 5000);
};
  return (
    <MDBContainer fluid>
        ...
        <MDBCol col='12'>
          <MDBCard className='bg-dark text-white my-5 mx-auto' style={{ borderRadius: '1rem', maxWidth: '500px' }}>
            <MDBCardBody className='p-5 d-flex flex-column align-items-center mx-auto w-100'>
              ...
              <p className="text-white-50 mb-5">Please enter your Official Email!</p>
